...
export default function EventSection() {
  return (
    <section id="event" className="relative py-20 px-6 bg-crimson-50 overflow-hidden">
          ...
          {events.map((event, index) => (
            <AnimatedSection key={event.title} delay={0.2 + index * 0.2}>
              <div className="glass-card p-6 md:p-8 text-center relative overflow-hidden">
                ...
                <h3 className="text-2xl font-serif text-crimson-800 mb-4">
                  {event.title}
                </h3>
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex items-center justify-center gap-2 text-crimson-600">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-crimson-400">{event.address}</p>
                    </div>
                  </div>
                </div>
