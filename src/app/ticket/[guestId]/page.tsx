    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-earth-50 px-6">
        <div className="text-center max-w-xs">
          <div className="w-16 h-16 rounded-full bg-crimson-100 flex items-center justify-center mx-auto mb-4">
            <span className="text-2xl">🎫</span>
          </div>
          <h1 className="font-serif text-crimson-800 text-xl mb-2">Tiket Tidak Ditemukan</h1>
          <p className="text-crimson-400 text-sm leading-relaxed">
